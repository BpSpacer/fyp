...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> = {
    meta: {
      modelProps: "user" | "order" | "seller" | "product"
  ...
  export interface Prisma__UserClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    Product<T extends User$ProductArgs<ExtArgs> = {}>(args?: Subset<T, User$ProductArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ProductPayload<ExtArgs>, T, "findMany", ClientOptions> | Null>
    /**
  ...
  export type OrderOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "status" | "amount" | "addressLine1" | "city" | "state" | "phone" | "notes" | "userId" | "createdAt", ExtArgs["result"]["order"]>
  ...
  export type SellerOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "firstName" | "lastName" | "fatherName" | "email" | "phone" | "cnic" | "accountType" | "accountNumber" | "createdAt", ExtArgs["result"]["seller"]>
  ...
  interface SellerFieldRefs {
    ...
    readonly fatherName: FieldRef<"Seller", 'String'>
    readonly email: FieldRef<"Seller", 'String'>
    readonly phone: FieldRef<"Seller", 'String'>
    readonly cnic: FieldRef<"Seller", 'String'>
    readonly accountType: FieldRef<"Seller", 'String'>
    readonly accountNumber: FieldRef<"Seller", 'String'>
  ...
  export type ProductMinAggregateOutputType = {
    ...
    category: $Enums.CategoryTypes | null
    createdAt: Date | null
    userId: string | null
  }
  ...
  export type ProductOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "price" | "smallDescription" | "description" | "images" | "productFile" | "category" | "createdAt" | "userId", ExtArgs["result"]["product"]>
  ...
  interface ProductFieldRefs {
    ...
    readonly smallDescription: FieldRef<"Product", 'String'>
    readonly description: FieldRef<"Product", 'Json'>
    readonly images: FieldRef<"Product", 'String[]'>
    readonly productFile: FieldRef<"Product", 'String'>
    readonly category: FieldRef<"Product", 'CategoryTypes'>
  ...
  export type SellerWhereInput = {
    ...
    firstName?: StringFilter<"Seller"> | string
    lastName?: StringFilter<"Seller"> | string
    fatherName?: StringFilter<"Seller"> | string
    email?: StringFilter<"Seller"> | string
    phone?: StringFilter<"Seller"> | string
    cnic?: StringFilter<"Seller"> | string
    accountType?: StringFilter<"Seller"> | string
    accountNumber?: StringFilter<"Seller"> | string
  ...
  export type SellerWhereUniqueInput = Prisma.AtLeast<{
    ...
    accountType?: StringFilter<"Seller"> | string
    createdAt?: DateTimeFilter<"Seller"> | Date | string
  }, "id" | "email" | "phone" | "cnic" | "accountNumber">
  ...
  export type SellerScalarWhereWithAggregatesInput = {
    ...
    firstName?: StringWithAggregatesFilter<"Seller"> | string
    lastName?: StringWithAggregatesFilter<"Seller"> | string
    fatherName?: StringWithAggregatesFilter<"Seller"> | string
    email?: StringWithAggregatesFilter<"Seller"> | string
    phone?: StringWithAggregatesFilter<"Seller"> | string
    cnic?: StringWithAggregatesFilter<"Seller"> | string
    accountType?: StringWithAggregatesFilter<"Seller"> | string
    accountNumber?: StringWithAggregatesFilter<"Seller"> | string
  ...
  export type ProductWhereInput = {
    ...
    smallDescription?: StringFilter<"Product"> | string
    description?: JsonFilter<"Product">
    images?: StringNullableListFilter<"Product">
    productFile?: StringFilter<"Product"> | string
    category?: EnumCategoryTypesFilter<"Product"> | $Enums.CategoryTypes
  ...
  export type ProductScalarWhereWithAggregatesInput = {
    ...
    smallDescription?: StringWithAggregatesFilter<"Product"> | string
    description?: JsonWithAggregatesFilter<"Product">
    images?: StringNullableListFilter<"Product">
    productFile?: StringWithAggregatesFilter<"Product"> | string
    category?: EnumCategoryTypesWithAggregatesFilter<"Product"> | $Enums.CategoryTypes
  ...
  export type ProductUpdateInput = {
    ...
    productFile?: StringFieldUpdateOperationsInput | string
    category?: EnumCategoryTypesFieldUpdateOperationsInput | $Enums.CategoryTypes
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
